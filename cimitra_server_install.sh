...
declare CUSTOM_LINK_NAME="Cimitra Documentation"
declare CUSTOM_LINK_ADDRESS="https://www.comitra.com/adminhelp"
declare CUSTOM_LINK_DESCRIPTION="Cimitra Documentation and Help"
declare -i CUSTOM_LINK_ENABLED="0"
