...
declare -i SCRIPT_NAME_HAS_POWERSHARE=`echo ${SCRIPT_NAME} | grep -c "go_powershare"`

if [ $SCRIPT_NAME_HAS_POWERSHARE -eq 0 ]
then
declare CIMITRA_SERVER_ADMIN_ACCOUNT="admin@cimitra.com"
else
declare CIMITRA_SERVER_ADMIN_ACCOUNT="admin@grouplink.com"
fi
