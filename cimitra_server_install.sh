...
then
sudo /var/opt/cimitra/api/server/create ${CIMITRA_SERVER_ADDRESS} ${CIMITRA_SERVER_PORT} ${CIMITRA_SERVER_ADMIN_ACCOUNT} ${CIMITRA_SERVER_ADMIN_PASSWORD} function=CREATE_CUSTOM_LINK linkName=${CUSTOM_LINK_NAME}^ linkLocation=${CUSTOM_LINK_ADDRESS}^ linkDescription=${CUSTOM_LINK_DESCRIPTION}^
fi
